...
# such nodes as well.
CONNECTED_NODE_ADDRESS = os.getenv("BACKEND_API")
...
def register():
    ...
    global host_url
    print(host_url)
    post_object = {"node_address": host_url}
...
def getPlotCSV():
    ...
    with open(f"consumer/resources/{file}") as fp:
        csv = fp.read()
    return Response(
        csv,
        mimetype="text/csv",
...
def get_file_list(path="consumer/resources"):
    global files
